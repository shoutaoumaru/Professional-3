          ...
          <div class="c-container">
            ...
            <div class="c-works-item__desc">
              <p class="c-txt-sm">
                ...
                また、一般に公開することにより、複雑な権利関係を誰にでもわかるようにし、安全且つ円滑に不動産取引をする役割を果しています。
              </p>
            </div>
          </div>
        </section>
